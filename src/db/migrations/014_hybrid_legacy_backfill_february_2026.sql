-- Align Hybrid canonical facts with legacy hyb_stats for all of February 2026.
-- Idempotent: delete the canonical window first, then rebuild from legacy daily creative rows.

DELETE FROM canonical_fact_ads_daily
WHERE source_key = 'hybrid'
  AND report_date BETWEEN '2026-02-01' AND '2026-02-28'
...
WHERE h.date BETWEEN '2026-02-01' AND '2026-02-28';
