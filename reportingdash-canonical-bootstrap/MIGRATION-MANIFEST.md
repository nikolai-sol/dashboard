...
| `lib/canonical_release_store.py` | `canonical_release_store.py` | `ded1942223a8488908a6a41a6ad03599ef181c7c66e96dce7acc4b5b54acd7b3` | Candidate release store, persisted validation gate, atomic activation, and rollback pointer management |
...
| `runtime/canonical_release_store.py` | `canonical_release_store.py` | `ded1942223a8488908a6a41a6ad03599ef181c7c66e96dce7acc4b5b54acd7b3` | Exact validation and pointer store |
