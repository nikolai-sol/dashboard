...
| `runtime/agents/abbott_page_classifier/candidate_release.py` | `agents/abbott_page_classifier/candidate_release.py` | `76b562b94746129b0b53c227d0146e8accc70678e24069b2e200c38b2bac87f3` | Shared content materializer with pre-attested return paths, resume-safe candidate lifecycle receipts, and read-only staging/validated comparison evidence |
| `runtime/agents/abbott_page_classifier/domain.py` | `agents/abbott_page_classifier/domain.py` | `e025f883caf749706fba4369020234b166417b7887665879f9e8fffeeb7b35ef` | Content taxonomy domain dependency |
...
| `runtime/agents/abbott_page_classifier/workflow_service.py` | `agents/abbott_page_classifier/workflow_service.py` | `90d2cf1b1b9cd0b91636c82fe404a2632f96879bf92e43560ad838990daecff3` | Canonical weekly proposal service |
| `runtime/agents/abbott_page_classifier/workflow_repository.py` | `agents/abbott_page_classifier/workflow_repository.py` | `7247fec6c67caf1894e2888852d889a7a22e07072f0830e6b12a0ef8f32e700f` | MySQL reconciliation staging repository |
