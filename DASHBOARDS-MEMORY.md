...
11. Zaruku portal BI dashboard was added as `dashboard_type = zaruku_bi`:
    ...
    - current connected onsite source is Yandex Metrika: canonical traffic/page facts plus `canonical_fact_metrika_segments_daily` cuts for search engines, phrases, organic landings, devices, geo, browser/OS, age/gender/interests; the dashboard does not call the live Metrika API
