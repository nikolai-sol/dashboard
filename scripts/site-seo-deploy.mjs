...
function main() {
  ...
  const manifest = manifestIndex >= 0 ? argv[manifestIndex + 1] : path.join(ROOT, "deploy/medroche/release.json");
  ...
  process.stdout.write(`${JSON.stringify(previewDeploy(path.resolve(manifest), repository))}\n`);
}
