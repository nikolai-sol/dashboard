...
export function buildRecoveryCapsule(sources,keys){
  ...
  for(const[name,file]of[['worker','abbott-runtime-release-remote.mjs'],['proof','bootstrap-abbott-host.mjs']]){
...
async function main(){
  ...
  const names={worker:'abbott-runtime-release-remote.mjs',proof:'bootstrap-abbott-host.mjs',recovery:'abbott-interrupted-recovery.mjs'};
