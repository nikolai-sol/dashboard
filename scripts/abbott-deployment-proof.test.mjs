...
const ID='978bab9dcd2b486d8c65f29960ef8eaa',SHA='62f034a6d3caabc66a9dcc033ec12a6e62979569',HASH='c74c91a9581f816de10cacb6c2cc15b920e11898331405194f3de5b6f1bf3027';
...
function fixture(){
 ...
 const record={scope:'abbott',id:ID,sourceSha:SHA,manifestDigest:HASH,previousId:'305cedd2321041b68b4d9e2cf502a2e0'};
 ...
 const options={io,hostname:()=> 'ybjqbzojln',getuid:()=>0,digest:b=>b.toString()==='manifest-fixture'?HASH:createHash('sha256').update(b).digest('hex'),verifyActive(r){calls.push('active');assert.deepEqual(r,record);},verifyBrowser(){calls.push('browser');return{archiveSha256:'2fc582be0fd0cffdd2d598a56c68f4a7f6b5bca4eb8d506c01b154eec649c4bd'};}};
