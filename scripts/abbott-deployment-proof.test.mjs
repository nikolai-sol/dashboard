...
function fixture(){
 ...
 const record={scope:'abbott',id:ID,sourceSha:SHA,manifestDigest:HASH,previousId:'770d6d8b7f904a1e9ae447c86f6065b5'};
...
test('proof is filesystem-only and real Abbott path wires it before any account/lock operation',()=>{
 const source=fs.readFileSync(new URL('./abbott-runtime-release-remote.mjs',import.meta.url),'utf8');
