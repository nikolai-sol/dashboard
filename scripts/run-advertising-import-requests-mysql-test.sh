...
container="reportingdash-ad-import-requests-mysql-$$"
password="advertising_import_requests_local_only"
...
ADVERTISING_IMPORT_REQUESTS_MIGRATION_TEST_URL="mysql://root:$password@127.0.0.1:$port/report_bd" \
  npx tsx scripts/verify-advertising-import-requests-mysql.ts
