...
function validRemoteDiagnostic(status,d){
 ...
 if(status==='REFUSED'&&d.stage==='preflight_nginx')return ['metadata','utf8','syntax','tls_count','include','nested_server','variable_routing','regex_location','unsupported_directive','existing_abbott_route','existing_3004','snapshot_drift','unknown'].includes(d.reason);
