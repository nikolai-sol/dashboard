...
const ID='47d27abb85b343f3a0200835e02cdcda',SHA='4904f6bb4c303684742f960fe51aae49f752214f',HASH='2d573ca69689de2f48642921697fe04aa8d4d49679fb96c9a4652392ac4fdc6e',PREVIOUS='1a63cbfda61f40d894af3e9744c093a3';
...
test('attestation rejects the predecessor f0b331f release after the observed 4904f6b deployment',async()=>{
...
test('actual sanitized deployed record has the exact accepted schema and pins',async()=>{
  const m=await api(),f=fixture(),bytes=fs.readFileSync(new URL('./fixtures/abbott-deployed-record-4904f6b.json',import.meta.url));
