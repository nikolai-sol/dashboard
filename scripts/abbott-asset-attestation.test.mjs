...
const ID='1a63cbfda61f40d894af3e9744c093a3',SHA='f0b331f0ee05b8d12438a843777ab8bfb7584acf',HASH='8520477ea708c5cbc3dd65f7ac9fbc71c090274607f6b466265a2007c974eba2',PREVIOUS='5ec3175697824126b8bc0be1b84e68f3';
...
test('attestation rejects the predecessor 55ec478 release after the observed f0b331f deployment',async()=>{
...
test('actual sanitized deployed record has the exact accepted schema and pins',async()=>{
  const m=await api(),f=fixture(),bytes=fs.readFileSync(new URL('./fixtures/abbott-deployed-record-f0b331f.json',import.meta.url));
