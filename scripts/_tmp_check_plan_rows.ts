...
import { fetchMediaPlanFromSourceConfig, type MediaPlanRow, type MediaPlanSourceConfig } from '../src/lib/gsheet-fetcher';

const sourceConfig: MediaPlanSourceConfig = {
