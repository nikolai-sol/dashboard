...
container="reportingdash-advertising-foundation-mysql-$$"
password="advertising_foundation_local_only"
...
ADVERTISING_INGESTION_MIGRATION_TEST_URL="mysql://root:$password@127.0.0.1:$port/report_bd" \
  npx tsx scripts/verify-advertising-ingestion-foundation-mysql.ts
